...
class Tablero:
    def __init__(self, size):
        ...
        self.size = size
        self.tablero = []
        self.trainer = Trainer(randint(0,self.size),randint(0,self.size), self.window, 'pokeball2')
        ...
        def Move(trainer):
            def rightMove(leaveBean=False):
                if leaveBean:
                    ...
                    self.tablero[trainer.y][trainer.x + 1] = Trainer(trainer.y, trainer.x + 1, self.window, 'pokeball1')
                else:
                    self.tablero[trainer.y][trainer.x + 1] = Trainer(trainer.y, trainer.x + 1, self.window, 'pokeball2')
